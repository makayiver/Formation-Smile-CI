...
#Sauvegarder les bases de données utiles avec la commande mysqldump et ziper le dossier les contenant
...
#Pour effectuer une sauvegade automatique chaque jour a 00H01min, il faut modifier le crontab du serveur en ajoutant$

#Ouvrir d'abord le crontab avec la commande crontab -e

##Code à copier    01      00      *       *        *       /backup/mariadb/test2.sh  ##
